...
int main(int argc, char *argv[]) /* 注意是char *argv[] */
{
    ...
    gtk_widget_set_size_request(window_notebook_person_combo_level, 100, 25);
    ...
    gtk_fixed_put(GTK_FIXED(window_notebook_person_fixed_29), GTK_WIDGET(window_notebook_person_label_level), 200, 25);
    gtk_fixed_put(GTK_FIXED(window_notebook_person_fixed_30), GTK_WIDGET(window_notebook_person_combo_level), 0, 25);

...
void window_notebook_treat_button_diagnose_callback(GtkWidget *widget, gpointer main_window)
{
    ...
    gtk_widget_set_size_request(GTK_WIDGET(window), 300, 360);
    ...
    /* 创建控件框架 */
    window_table = gtk_table_new(5, 2, FALSE);
    ...
    window_fixed_7 = gtk_fixed_new();
    window_fixed_8 = gtk_fixed_new();
    window_fixed_9 = gtk_fixed_new();
    window_fixed_10 = gtk_fixed_new();
    /* 创建控件 */
    ...
    window_check_7 = gtk_check_button_new_with_label("兴奋症状");
    window_check_8 = gtk_check_button_new_with_label("偏执状态");
    window_check_9 = gtk_check_button_new_with_label("缄默状态");
    window_check_10 = gtk_check_button_new_with_label("焦虑状态");
    /* 设置控件默认大小 */
    ...
    gtk_widget_set_size_request(window_check_7, 100, 40);
    gtk_widget_set_size_request(window_check_8, 100, 40);
    gtk_widget_set_size_request(window_check_9, 100, 40);
    gtk_widget_set_size_request(window_check_10, 100, 40);
    /* 将控件放入GtkFixed框架 */
    ...
    gtk_fixed_put(GTK_FIXED(window_fixed_7), GTK_WIDGET(window_check_7), 50, 25);
    gtk_fixed_put(GTK_FIXED(window_fixed_8), GTK_WIDGET(window_check_8), 25, 25);
    gtk_fixed_put(GTK_FIXED(window_fixed_9), GTK_WIDGET(window_check_9), 50, 25);
    gtk_fixed_put(GTK_FIXED(window_fixed_10), GTK_WIDGET(window_check_10), 25, 25);
    ...
    gtk_table_attach(GTK_TABLE(window_table), window_fixed_7, 0, 1, 3, 4, GTK_FILL, GTK_SHRINK, 0, 0);
    gtk_table_attach(GTK_TABLE(window_table), window_fixed_8, 1, 2, 3, 4, GTK_FILL, GTK_SHRINK, 0, 0);
    gtk_table_attach(GTK_TABLE(window_table), window_fixed_9, 0, 1, 4, 5, GTK_FILL, GTK_SHRINK, 0, 0);
    gtk_table_attach(GTK_TABLE(window_table), window_fixed_10, 1, 2, 4, 5, GTK_FILL, GTK_SHRINK, 0, 0);
